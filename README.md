# The github repository storing source code presented in "Complex Event Analysis for Traffic Risk Predictionbased on 3D-CNN with Multi-sources Urban Sensing Data"
...
* learning_model: 
    * Historical_Average: a statistical model to predict spartial-temporal data based on Historical Average
        * predict.py: to predict data
    * 2D_CNN: a deep learning model predict spartial-temporal data using 2D-CNN
        * train.py: to train the model
        * predict.py: to predict data
    * 3D_CNN: a deep learning model predict spartial-temporal data using 3D-CNN
